...
const categories = [
  { label: "Surface sports", id: "surface-sports" },
  { label: "Water sports", id: "water-sports" },
  { label: "Small sports", id: "small-sports" },
  { label: "Budget sports", id: "budget-sports" },
  { label: "Sports academies", id: "sports-academies" },
  { label: "Play zones", id: "play-zones" },
  { label: "Adventure sports", id: "adventure-sports" },
  { label: "Challenge courses", id: "challenge-courses" },
  { label: "Talent scout clubs", id: "talent-scout-clubs" },
];
...
const productsData = [
  ...
  // Adventure Sports
  { slug: "zipline-kit", name: "Zipline System", category: "adventure-sports", shortSpec: "High Safety", description: "Full zipline infrastructure for adventure parks.", imageUrl: "/images/sports/surface_sports.png" },
  { slug: "high-ropes-course", name: "Ropes Course", category: "adventure-sports", shortSpec: "Modular Design", description: "Challenging aerial ropes course elements.", imageUrl: "/images/sports/surface_sports.png" },
...
async function main() {
  ...
  // Ensure categories exist in Category table
  for (const cat of categories) {
    await prisma.category.upsert({
      where: { label: cat.label },
      update: { id: cat.id }, // Ensure IDs match slugs used in products
      create: { id: cat.id, label: cat.label, order: 0 },
    });
  }
